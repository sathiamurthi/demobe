...
INSERT INTO Employees (EmployeeId, EmployeeName, EmployeeRole, EmployeeEmail, EmployeeStudio, EmployeeSubStudio, EmployeeLocation, EmployeeJoiningDate, EmployeeEndingDate, EmployeeSkills, EmployeeKekaStatus, EmployeeContractType, EmployeeTYOE, EmployeePhotoDetails) VALUES
    ('INN001', 'Shubham Kumawat', 'Leader', 'Shubham.kumawat@innoverdigital.com', 'Data & Insights', 'Advanced Analytics', 'USA', '2018-06-15', NULL, 'Python, SQL, Tableau', 'Active', 'FTE', 6, NULL),
    ...
    ('INN004', 'Shiraz', 'Employee', 'Mohammed.khan@innoverdigital.com', 'Digital Experiences', 'Digital Ops', 'USA', '2019-03-05', NULL, 'Adobe XD, Sketch, User Research', 'Active', 'FTE', 5, NULL),
...
-- -----------------------------------------------------
-- Assign actual project managers from the Employees table
...
-- -----------------------------------------------------
-- Optional: Insert Initial Data into Allocations
-- -----------------------------------------------------
-- No changes needed here as AllocationTimeSheetApproverID already exists before AllocationTimeSheetApprover
