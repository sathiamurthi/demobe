...
module.exports = async function (context, req) {
  // SQL query to fetch employees who are currently on the "bench" (allocated to ClientID = 1)
  const query = `
    SELECT
  ...
  try {
    ...
    // Format the results for consistent response structure
    ...
    context.log('Error executing bench query:', err);
    context.res = {
      status: 500,
